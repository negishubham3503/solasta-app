...
const event_det = ()=> [
    ...
    },
    {
        photography : [
            ...
            },
            {
                ...
                price : ' ₹750/-',
                rules : ['The competition will be held at on the spot',
    ...
    },
    {
        drama:[
            {
                name:'Befkir',
                desc:'Blow the theartical fire and show your play',
                price:' ₹3,000/-',
                ...
                'The play could be presented in any language.',
            ...
            },
            {
                ...
                price:'₹1,000/-',
                rules:['Duration of movie should be confined to 7-10 minutes.',
                'The short movie must be produced after 08-mar-2019.',
                'The movie shall be suitable for all audiences',
                'The organisers decision will be final.',
                'Top 5 clips will screened with audience',
                    ],
            ...
            },
            {
                ...
                'Time alloted & marks/question for each round of competition will be declared before hand',
                'Quiz master is god .He has the final say.',
                'Quiz rules & regulation will explained on quiz day',
                    ],
            ...
            rules:['use of fire is not allowed(*kettle allowed )',
                    'We will just provide basic things',
    ...
    },
    {
        emc:[
            ...
            },
            {
                ...
                rules:[
                    'ROUND :1(DAY-1)\
                    Two bots fight at once and the warrior walks to further round while looser walks out.\
                    ROUND:2(DAY-1){Time Out Mode}\
                    Two bots fight at once. Four beasts with least knock out time shall triumph.\
                    ROUND :3(DAY-2){Rob Mode}\
                    All 4 bots fight at once, no time limit, last bot to stand will seize the glory. \
                    ...
                    'Bot is verified before entry and should not exceed\
                    the limit.'
                ],
                contact:[
                    'SURYA TEJA.B\
            ...
            },
            {
                ...
                rules:[
                    ...
                    'Each team can have max 6 members'
                ],
                contact:[
                    'V.Sainath\
        ...
        mech:[
            {
                ...
                price:'₹3,500/-',
                rules:['Round 1A:',
                'A quiz where all solutions need not be written (i.e participants can express solutions pictorially)',
                'Quiz shall be conducted on an individual basis and team members\' score will be averaged.',
                'TOP 6 TEAMS WILL BE ELIGIBLE FOR A BONUS ROUND AND FINALS',
                'Mantle-dismantle (bonu roud):',
                ...
                'The selected participants will choose the tools and components required from a provided assortment to builld the required prototype',
        ...
        Workshop:[
            {
                ...
                desc:'This workshop invites those puzzle solving enthusiasts who are interested in learning\
                how to solve a 3x3x3 Rubik’s cube and how to decrease their solving time and master\
                the art of solving a 3x3x3 Rubik’s cube in just a few seconds.',
                price:'₹3,000/-',
                rules:['WORKSHOP DETAILS:',
                'Each individual will be provided with the workshop kit compromising of the study\
            ...
            },
            {
                ...
                price: '  ',
                desc:'Interactiv lecture sessions where participants will be able to develop their own android applications',
                rules:[
                    'workshop fee: ₹150 ',
                    'TOPICS COVERED: ',
